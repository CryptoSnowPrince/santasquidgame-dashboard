...
const WrapMenuEntry = styled.div<{ isActive: boolean }>`
  box-shadow: ${({ isActive }) => (isActive ? `0px 0px 10px 0px #9f5444` : "none")};
  margin-top: 10px
`;
...
const TelegramIcon = () => {
  return <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-telegram" viewBox="0 0 16 16">
...
const TradeIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-cash-coin" viewBox="2 2 20 18">
...
const TwitterIcon = () => {
  return (<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-twitter" viewBox="0 0 16 16">
